...
class StreamsBrokerCompatibility(Test):
    ...
    @cluster(num_nodes=4)
    @parametrize(broker_version=str(LATEST_3_3), metadata_quorum=quorum.remote_kraft)
    ...
    @parametrize(broker_version=str(LATEST_2_7), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_6), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_5), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_4), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_3), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_2), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_1), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_2_0), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_1_1), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_1_0), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_0_11_0), metadata_quorum=quorum.remote_kraft)
    ...
    @cluster(num_nodes=4)
    @parametrize(broker_version=str(LATEST_0_10_2), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_0_10_1), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_0_10_0), metadata_quorum=quorum.remote_kraft)
    ...
    @parametrize(broker_version=str(LATEST_1_0), metadata_quorum=quorum.remote_kraft)
    @parametrize(broker_version=str(LATEST_0_11_0), metadata_quorum=quorum.remote_kraft)
    def test_fail_fast_on_incompatible_brokers_if_eos_v2_enabled(self, broker_version, metadata_quorum=quorum.remote_kraft):
        self.kafka.set_version(KafkaVersion(broker_version))
        self.kafka.start()
