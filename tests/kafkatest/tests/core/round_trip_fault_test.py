...
class RoundTripFaultTest(Test):
    ...
    def __init__(self, test_context):
        ...
        active_topics={topic_name : {"partitionAssignments":{"0": [1], "1": [2], "2": [3]}}}
    ...
    def test_round_trip_workload(self, metadata_quorum=quorum.remote_kraft):
        workload1 = self.trogdor.create_task("workload1", self.round_trip_spec)
        workload1.wait_for_done(timeout_sec=600)

    @cluster(num_nodes=9)
    @matrix(metadata_quorum=quorum.all_non_upgrade)
    def test_round_trip_workload_with_broker_partition(self, metadata_quorum=quorum.remote_kraft):
        workload1 = self.trogdor.create_task("workload1", self.round_trip_spec)
        time.sleep(2)
    ...
    @cluster(num_nodes=9)
    @matrix(metadata_quorum=quorum.all_non_upgrade)
    def test_produce_consume_with_broker_pause(self, metadata_quorum=quorum.remote_kraft):
        workload1 = self.trogdor.create_task("workload1", self.round_trip_spec)
        time.sleep(2)
    ...
    @cluster(num_nodes=9)
    @matrix(metadata_quorum=quorum.all_non_upgrade)
    def test_produce_consume_with_client_partition(self, metadata_quorum=quorum.remote_kraft):
        workload1 = self.trogdor.create_task("workload1", self.round_trip_spec)
        time.sleep(2)
    ...
    @cluster(num_nodes=9)
    @matrix(metadata_quorum=quorum.all_non_upgrade)
    def test_produce_consume_with_latency(self, metadata_quorum=quorum.remote_kraft):
        workload1 = self.trogdor.create_task("workload1", self.round_trip_spec)
        time.sleep(2)
