...
class ClientCompatibilityTestNewBroker(ProduceConsumeValidateTest):
    ...
    @parametrize(producer_version=str(DEV_BRANCH), consumer_version=str(LATEST_0_9), compression_types=["none"], new_consumer=False, timestamp_type=None, metadata_quorum=quorum.remote_kraft)
    ...
    @parametrize(producer_version=str(LATEST_0_8_2), consumer_version=str(LATEST_0_8_2), compression_types=["none"], new_consumer=False, timestamp_type=None, metadata_quorum=quorum.remote_kraft)
    def test_compatibility(self, producer_version, consumer_version, compression_types, new_consumer=True, timestamp_type=None, metadata_quorum=quorum.remote_kraft):
