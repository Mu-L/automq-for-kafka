...
class MessageFormatChangeTest(ProduceConsumeValidateTest):
    ...
    @matrix(producer_version=[str(DEV_BRANCH)], consumer_version=[str(DEV_BRANCH)], metadata_quorum=quorum.all)
    @matrix(producer_version=[str(LATEST_0_10)], consumer_version=[str(LATEST_0_10)], metadata_quorum=quorum.all)
    @matrix(producer_version=[str(LATEST_0_9)], consumer_version=[str(LATEST_0_9)], metadata_quorum=quorum.all)
    def test_compatibility(self, producer_version, consumer_version, metadata_quorum=quorum.remote_kraft):
